...
function NotifyModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/30" onClick={onClose}>
      <div
        className="bg-white rounded-2xl border border-[#e8e2dc] shadow-xl w-full max-w-md max-h-[85dvh] flex flex-col pb-20 lg:pb-0"
...
function AddWaitlistModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center p-4 bg-black/30" onClick={onClose}>
      <div
        className="bg-white rounded-2xl border border-[#e8e2dc] shadow-xl w-full max-w-md max-h-[85dvh] overflow-y-auto pb-20 lg:pb-0"
        onClick={(e) => e.stopPropagation()}
      >
        <div className="p-5 border-b border-[#e8e2dc]">
