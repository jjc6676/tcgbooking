    ...
    if (this.state.hasError) {
      ...
      return (
        <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 text-center">
          <div className="w-16 h-16 rounded-full bg-[#2e2326] flex items-center justify-center mx-auto mb-4">
          ...
          <h2 className="font-display text-xl text-[#28231c] mb-2">Something went wrong</h2>
          <p className="text-sm text-[#655356] mb-6 max-w-xs">
          ...
          <button
            ...
            className="px-6 py-2.5 bg-[#513b3c] text-white text-sm font-semibold rounded-full hover:bg-[#3d2c2d] transition-colors"
          >
            Refresh Page
          </button>
        </div>
